...
pub struct Table<R: CompRow> {
    ...
    /// An upper bound for the music score per row generated by any possible segment of any
    /// possible course
    best_music_density: f32,
    lengths: Vec<usize>,
    stage: Stage,
}
...
impl Table<Row> {
    ...
    pub fn new(
        ...
        let mut best_music_density = f32::NEG_INFINITY;
        let music_tables = ranges
            ...
            .map(|(i, r)| {
                ...
                best_music_density =
                    best_music_density.max(best_music_score / range_lengths[i] as f32);
                music_table
            })
            .collect_vec();
    ...
    pub fn change_row_type<R: CompRow + From<Row>>(self) -> Table<R> {
        Table {
            ...
            best_music_density: self.best_music_density,
        }
    }
}
...
impl<R: CompRow> engine::Table<R> for Table<R> {
    ...
    fn music_upper_bound(&self, num_rows: usize) -> f32 {
        ...
        self.best_music_density * num_rows as f32
    }
