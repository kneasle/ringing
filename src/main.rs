...
mod tables {
    #![allow(dead_code)]
    use crate::single_meth::{far_calls, Table};

    use super::*;

    pub fn bristol_s8() -> Table<Row> {
        Table::from_place_not(
            Stage::MAJOR,
    ...
    pub fn yorkshire_s10() -> Table<Row> {
        Table::from_place_not(
            Stage::ROYAL,
