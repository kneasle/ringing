...
use crate::{
    ...
    utils::{group::PartHead, Counts, PerPartLength, Score},
};
...
pub struct Composition {
    ...
    /// The average score generated by each row in the composition.   This is used to rank
    /// compositions to prevent the search algorithm being dominated by long compositions.
    pub(crate) avg_score: Score,
}
