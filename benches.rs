...
fn main() {
    ...
    for test in test_cases() {
        ...
        // Next up, check that every non-worst expected comp is found somewhere within the output.
        // Because both sets of comps are the same size, this is a sufficient condition for
        // equality.
