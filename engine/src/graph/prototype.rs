...
impl ProtoGraph {
    ...
    pub fn from_layout(layout: &Layout, max_length: usize) -> Self {
        let mut graph = Self::reachable_graph(layout, max_length);
        ...
        loop {
            ...
            // - Reorder successor links so that the ones with easily reachable music are explored
            //   first
    ...
    fn reachable_graph(layout: &Layout, max_length: usize) -> Self {
